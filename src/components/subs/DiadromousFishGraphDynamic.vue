<!-- 
 DiadromousFishGraphDynamic.vue
 This file serves as the dynamic version of the DiadromousFishGraph.vue. It is the pop-out version of the
 right-hand side bar diadromous fish stacked bar chart, available when the red "printer" icon is clicked on.
 This dynamic graph provides the user with a larger graph with printing and save-as-image capabilities.
 This dynamic graph will represent the data that is in the right-hand side bar, reflecting any fish run 
 selections made prior to clicking the red "printer" icon.
...
data() {
  ...
  methods: {
    // method to update the chart with the selected data
    updateChart(newData) {
      ...
      if (this.$refs.chart) {
        ...
        chart.update({
          ...
          // return to All Accessible Areas data
          series_a.setData([
